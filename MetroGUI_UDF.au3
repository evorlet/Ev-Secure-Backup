...
; Syntax ........: _Metro_CreateGUI($Title, $Width, $Height[, $Left = -1[, $Top = -1[, $AllowResize = False[,
...
;                  $AllowResize         - [optional] Borderless window that allows drag, resize and also keeps the AeroSnap functions working. Default is False.
...
;
;                  $ControlButtons      - [optional] Adds Close,Maximize/Restore and Minimize buttons to the GUI. Default is False.
...
; ===============================================================================================================================
Func _Metro_CreateGUI($Title, $Width, $Height, $Left = -1, $Top = -1, $AllowResize = False, $ControlButtons = False, $ParentGUI = "")
	Local $GUI_Return[6]
	...
	If $ControlButtons Then
		$Control_Buttons = _Metro_CreateControlButtons($GUI_Return[1], $GUI_Return[0], $GUIThemeColor, $FontThemeColor, $AllowResize, $ControlThickStyle, False)
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _Metro_CreateControlButtons
; Description ...: Internal use only. Creates the GUI control buttons for Close,Maximize/Restore and Minimize.
; ===============================================================================================================================
Func _Metro_CreateControlButtons(ByRef $GUI_HOVER_REG, $hForm, $GUI_BG_Color = $GUIThemeColor, $GUI_Font_Color = "0xFFFFFF", $MaximizeButton = True, $ThickStyle = $ControlThickStyle, $CloseButtonOnStyle = False)
	...
	If Not $MaximizeButton Then;Disable maximize and restore buttons
		GUICtrlSetState($Button_Maximize_Array[0], 128)
		GUICtrlSetState($Button_Restore_Array[0], 128 + 32)
	Else
...
EndFunc   ;==>_Metro_CreateControlButtons
...
;                  $Font_Color = $ButtonTextColor[, $Font = "Calibri Light"[, $Fontsize = 12.5[, $FontStyle = 1[,
;                  $FrameColor = "0xFFFFFF"]]]]]])
; Parameters ....: $GUI_HOVER_REG       - The variable for the GUI_HOVER_REG array created by _Metro_CreateGUI.
...
;                  $Font            	- [optional] Font. Default is "Calibri Light".
...
Func _Metro_CreateButtonEx(ByRef $GUI_HOVER_REG, $Text, $Left, $Top, $Width, $Height, $BG_Color = $ButtonBKColor, $Font_Color = $ButtonTextColor, $Font = "Calibri Light", $Fontsize = 12.5, $FontStyle = 1, $FrameColor = "0xFFFFFF")
...
;                  $FontColor = $ButtonTextColor[, $Font = "Calibri Light"[, $Fontsize = 12.5[, $FontStyle = 1 $FrameColor = "0xFFFFFF"]]]]])
; Parameters ....: $GUI_HOVER_REG       - The variable for the GUI_HOVER_REG array created by _Metro_CreateGUI.
;                  $Text            - Text of the button.
;                  $Left               - Left pos.
;                  $Top                - Top pos.
...
Func _Metro_CreateButton(ByRef $GUI_HOVER_REG, $Text, $Left, $Top, $Width, $Height, $BGColor = $ButtonBKColor, $FontColor = $ButtonTextColor, $Font = "Calibri Light", $Fontsize = 12.5, $FontStyle = 1, $FrameColor = "0xFFFFFF")
...
;                  $NoAnimation         - True/False: Allows checking the toggle without any animation. Use this if your GUI is visible yet.
; ===============================================================================================================================
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _Metro_MsgBox
; Description ...: Creates a metro style MsgBox with an OK button.
; Syntax ........: _Metro_MsgBox($Title, $Text[, $mWidth = 600[, $FontSize = 14[, $ParentGUI = ""]]])
; Parameters ....: $Title               - Title of the MsgBox.
...
; ===============================================================================================================================
Func _Metro_MsgBox($Title, $Text, $mWidth = 600, $Fontsize = 13, $ParentGUI = "")
	If ($mWidth < 180) Then Return SetError(1)
	Local $LabelSize = _StringSize($Text, $Fontsize / $Font_DPI_Ratio, 400, 0, "Calibri", $mWidth - 30)
	...
	_GUICtrlSetFont(-1, 13, 400, 0, "Calibri")
	GUICtrlCreateLabel($Text, 15, 50, $LabelSize[2], $LabelSize[3], -1, 0x00100000)
	GUICtrlSetBkColor(-1, $GUIThemeColor)
	GUICtrlSetColor(-1, $FontThemeColor)
	_GUICtrlSetFont(-1, $Fontsize, 400, 0, "Calibri")
	GUICtrlCreateLabel("", 2, $mHeight - 53, ($mWidth - 128) / 2, 50, -1, 0x00100000)
	GUICtrlCreateLabel("", $mWidth - (($mWidth - 128) / 2), $mHeight - 53, ($mWidth - 128) / 2 - 2, 50, -1, 0x00100000)
	Local $Button_OK = _Metro_CreateButton($MSGBOX_HOVER_REG, "OK", ($mWidth - 120) / 2, $mHeight - 50, 120, 36, $ButtonBKColor, $ButtonTextColor)
